...
->Step:16 Make a Router,Step:17 Dry up your views,Step:19 Forms, Request Types, and Routing,Step:24 Switch to Namespaces are performed in LARAVEL


->CRUD operations without resources 
...
<?php
	...
	Route::get('/editdata/{id}','dmlController@editdata');
	Route::any('/update','dmlController@updatedata');
	Route::get('/deletedata/{id}','dmlController@deletedata');
?>
Migration file
